...
<body>
	<div class="bodymail">
		...
		<div class="block text-left padding">
			...
			<a href="#" style="text-decoration: none; color: white; border: 1px solid #B2DA9F; background-color: #B2DA9F; padding: 10px 13px; border-radius: 28px; font-size: 14px;">CONFIRMAR</a></p>
			<br>
			...
			<br>
			<a href="#" style="font-size: 16px;">http://dinbet/qr/confirmar/f$232V97vh%b2mp=qwe</a>
			</p>
		</div>
