...
<body>
	<div class="bodymail">
		...
		<div class="block">
			<img src="../../public/images/icons/alerta.png">
		</div>
		<div class="block padding text-purple">
			<p>Has desactivado la alerta de mascota perdida</p>
		</div>
		<div class="block text-left padding">
			<p>Hola {!nombre!} {!apellido!},</p>
			<p>Has desactivado la ALERTA DE MASCOTA PERDIDA de tu mascota {!nombremascota!}, esperamos que la hayas recuperado sin problema. </p>
			<br>
			<p>Si necesitas que te ayudemos en algo no tienes más que contactar con nuestro servicio de atención al cliente en qr@dinbeat.com y te contestaremos lo antes posible.</p>
			<br>
			...
			<br>
			<p>Gracias por confiar la identificación de tu mascota a nuestras placas DinbeatQR, esperamos que todo haya ido bien con {!nombremascota!} y esté en casa de nuevo.</p>
		</div>
