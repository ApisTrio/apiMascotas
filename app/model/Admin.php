...
class Admin
{
    ...
    public function superBusqueda($args)
    {
        try
        {
            ...
            if ( !empty($args[]) ) {
                $sql = "SELECT usuarios.idusuario, usuarios.usuario, duenos.nombre, duenos.apellido, duenos.telefono, duenos.pais, duenos.provincia, duenos.ciudad, duenos.codigo_postal, usuarios.emailU, usuarios.duenos_idDueno FROM usuarios INNER JOIN duenos ON usuarios.duenos_idDueno = duenos.idDueno"
            }
